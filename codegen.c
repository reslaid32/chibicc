...
static bool
has_flonum(Type* ty, int lo, int hi, int offset)
{
...
static void
push_args2(Node* args, bool first_pass)
{
  if (!args)
    return;
...
static void
store_fp(int r, int offset, int sz)
{
  switch (sz)
  {
  case 4:
...
static void
store_gp(int r, int offset, int sz)
{
  switch (sz)
  {
  case 1:
